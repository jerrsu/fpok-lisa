                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input id="idpegawai" type="hidden" name="idpegawai" value="{{  $data->idpegawai }}"  readonly="">
                        ...
                        <!-- <div class="form-group">
                         ...
                         <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="level" required="">
                                <option value="{{$role2->id}}">{{$role2->nama_role}}</option>
                                <option value=""></option>
            ...
            <div class="modal-body">
                <table id="lookup" class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="pilihPegawai" username="<?php echo $datas->nip; ?>" name="<?php echo $datas->nama; ?>" idpegawai="<?php echo $datas->id; ?>" >
                        <td>{{$datas->id}}</td>
                        <td>{{$datas->nip}}</td>
                            <td>{{$datas->nama}}</td>
                        </tr>
