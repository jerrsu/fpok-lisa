...
<form method="POST" action="{{ route('dataskp.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data SKP baru</h4>                      
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="tahun" type="date" class="form-control" name="tahun" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}"   >
                            </div>
                        </div>
                        <div class="form-group">
