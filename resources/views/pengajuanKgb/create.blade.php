...
<form method="POST" action="{{ route('pengajuankgb.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
                    ...
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Pengajuan</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                            <input id="ttl" name="ttl"  class="form-control" required readonly="" size="20"  >
                            </div>
                        </div>
                        <div class="form-group">
                        <label for="tgllahir" class="col-md-2 control-label">Tanggal Lahir</label>                           
                            <div class="col-md-6">
                            <input id="tanggallahir"  class="form-control"  name="tanggallahir" required readonly="" size="14"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="gajilama" type="number" class="form-control" name="gajilama"   >
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="oleh_pejabat" class="col-md-4 control-label">Oleh Pejabat</label>
                            <div class="col-md-6">
                                <input id="pejabat" type="text" class="form-control" name="pejabat"   >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="tglberlaku" type="date" class="form-control" name="tglberlaku" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="masatgl" type="date" class="form-control" name="masatgl" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}"  >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="gapokbaru" class="col-md-4 control-label">Gaji Pokok Baru</label>
                            <div class="col-md-3">
                            <input id="gajibaru" type="number" class="form-control" name="gajibaru"   >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="berdasarmasakerja" class="col-md-4 control-label">Berdasarkan Masa Kerja</label>
                            <div class="col-md-3">
                                <input id="masakerja" type="date" class="form-control" name="masakerja" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}"  >
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('idpangkatbaru') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="namapangkatbaru" type="text" class="form-control" readonly="" required  >
                                <input id="idpangkatbaru" type="hidden" name="idpangkatbaru" required readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="mulaitgl" type="date" class="form-control" name="mulaitgl" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}"  >
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group{{ $errors->has('iddekan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="namadekan" type="text" class="form-control" readonly=""  required>
                                <input id="iddekan" type="hidden" name="iddekan" required readonly="">
                                <span class="input-group-btn">
...
<div class="modal fade bd-example-modal-lg" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-lg" role="document" >
        <div class="modal-content" style="background: #fff;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cari Dekan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <table id="lookup5" class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        @foreach($datapegawai as $data)
                        <tr class="pilihDekan" namadekan="<?php echo $data->nama; ?>" iddekan="<?php echo $data->id; ?>" >
                        <td>{{$data->id}}</td>
                        <td>{{$data->nip}}</td>
                        <td>{{$data->nama}}</td>
                        </tr>
