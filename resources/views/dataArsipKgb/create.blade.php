...
<form method="POST" action="{{ route('arsipkgb.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Arsip KGB</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="masa" type="text" class="form-control" name="masa"  >                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tmt" class="col-md-4 control-label">TMT KGB</label>
                            <div class="col-md-6">
                                <input id="tmt" type="text" class="form-control" name="tmt"  >                                
                            </div>
                        </div>
                        <div class="form-group">
