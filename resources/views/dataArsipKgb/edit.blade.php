...
<form action="{{ route('arsipkgb.update', $data->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
<div class="row">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group">
                            <label for="no" class="col-md-4 control-label">Nomor KGB</label>
                            <div class="col-md-6">
                                <input id="no" type="text" class="form-control" value="{{ $data->no }}" name="no"  >                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tgl" class="col-md-4 control-label">Tanggal KGB</label>
                            <div class="col-md-3">
                                <input id="tgl" type="date" class="form-control" name="tgl" value="{{ $data->tgl }}"   >
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="gaji" class="col-md-4 control-label">Gaji Pokok Baru</label>
                            <div class="col-md-6">
                                <input id="gaji" type="text" class="form-control" name="gaji" value="{{ $data->gaji }}"  >                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="masa" class="col-md-4 control-label">Masa Kerja</label>
                            <div class="col-md-6">
                                <input id="masa" type="text" class="form-control" name="masa" value="{{ $data->masa }}"   >                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tmt" class="col-md-4 control-label">TMT KGB</label>
                            <div class="col-md-6">
                                <input id="tmt" type="text" class="form-control" name="tmt" value="{{ $data->tmt }}"  >                                
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <a href="{{route('arsipkgb.index')}}" class="btn btn-light pull-right">Back</a>
                    </div>
                  </div>
                </div>
              </div>
