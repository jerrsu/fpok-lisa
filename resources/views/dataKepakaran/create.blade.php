...
<form method="POST" action="{{ route('datakepakaran.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Kepakaran baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="idpegawai" type="hidden" name="idpegawai" value="{{ old('id') }}" required readonly="">
                        ...
                        <div class="form-group{{ $errors->has('matakuliah') ? ' has-error' : '' }}">
                            <label for="matakuliah" class="col-md-4 control-label">Nama Mata Kuliah <code>*</code></label>
                            <div class="col-md-6">
                                <input id="matakuliah" type="text" class="form-control" name="matakuliah"  >
