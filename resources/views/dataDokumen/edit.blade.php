...
<form action="{{ route('datadokumen.update', $data->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
<div class="row">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="namadok" type="text" class="form-control" name="namadok" value="{{ $data->namadok }}"  >
