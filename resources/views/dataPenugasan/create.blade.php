...
<form method="POST" action="{{ route('datapenugasan.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Penugasan baru</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="nosurat" type="text" class="form-control" name="nosurat"   >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="lama" type="text" class="form-control" name="lama"  >
