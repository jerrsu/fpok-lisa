...
<form method="POST" action="{{ route('datastudy.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Study Lanjut baru</h4>
                        ...
                        <div class="form-group">
                            <label for="perguruan" class="col-md-4 control-label">Nama Perguruan Tinggi </label>
                            <div class="col-md-6">
                                <input id="perguruan" type="text" class="form-control" name="perguruan"  >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="negara" type="text" class="form-control" name="negara"  >
