...
<form method="POST" action="{{ route('datapenghargaan.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Penghargaan baru</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="penghargaan" type="text" class="form-control" name="penghargaan" >
                        ...
                        <div class="form-group">
                            <label for="filesk" class="col-md-4 control-label">File Penghargaan <code>*</code></label>
                            <div class="col-md-6">
