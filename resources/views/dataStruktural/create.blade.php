...
<form method="POST" action="{{ route('datastruktural.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Jabatan Struktural</h4>
                        ...
                        <div class="form-group{{ $errors->has('idstruktural') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="namastruktural" type="text" class="form-control" readonly="" required>
                                <input id="idstruktural" type="hidden" name="idstruktural" value="{{ old('idstruktural') }}" required readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-3">
                                <input id="tmt2" type="date" class="form-control" name="tmt2" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}"     >
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-6">
                                <input id="filesk" type="file" class="form-control" name="filesk" value="{{ old('filesk') }}"   >
