...
<form action="{{ route('pasangan.update', $data->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Edit Data Suami / Istri</b> </h4>
                      ...
                      <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                            <label for="nama" class="col-md-4 control-label">Nama Lengkap Pasangan<code>*</code></label>
                            <div class="col-md-6">
                        ...
                        <a href="{{route('pasangan.index')}}" class="btn btn-light pull-right">Back</a>
                    </div>
                  </div>
                </div>
              </div>
