...
<form action="{{ route('pengajuancuti.update', $data->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
<div class="row">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group{{ $errors->has('idpegawai') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                            <input id="nip" type="text" class="form-control" value="{{ $getpegawai->nip }}" name="nip"    required readonly="">
                            </div>
                        </div>                         
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="nama_unit" type="text" class="form-control" readonly="" value="{{ $getdataunit->nama_unit }}" required  >
                                <input id="id_unit_kerja" type="hidden" name="id_unit_kerja" value="{{ $data->idunit}}" readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('idjabatan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="namajabatan" type="text" class="form-control" readonly=""  required value="{{ $getjabatan->nama_jabatan }}">
                                <input id="idjabatan" type="hidden" name="idjabatan" value="{{ $data->idjabatan }}" required readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="masakerja" type="text" class="form-control" name="masakerja" value="{{ $data->masakerja }}"  >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jenis_cuti"   >
                                <option selected="selected">{{$data->jenis_cuti}}</option>
                                <option value="-"></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="alasan_cuti" type="text" class="form-control" name="alasan_cuti" value="{{ $data->alasan_cuti }}"  >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lama_cuti" class="col-md-4 control-label">Lamanya Cuti</label>
                            <div class="col-md-6">
                                <input id="lama_cuti" type="text" class="form-control" name="lama_cuti" value="{{ $data->lama_cuti }}"   >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="start_date" class="col-md-4 control-label">Tanggal Awal Cuti</label>
                            <div class="col-md-3">
                                <input id="start_date" type="date" class="form-control" name="start_date" value="{{ $data->start_date }}"   >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="end_date" class="col-md-4 control-label">Tanggal Akhir Cuti</label>
                            <div class="col-md-3">
                                <input id="end_date" type="date" class="form-control" name="end_date" value="{{ $data->end_date }}"   >
                            </div>
                        </div>                        
                        <div class="form-group">
                            <label for="catatan_cuti" class="col-md-4 control-label">Catatan Cuti</label>
                            <div class="col-md-8">
                                <input id="catatan_cuti" type="text" class="form-control" name="catatan_cuti" value="{{ $data->catatan_cuti }}"   >
                            </div>
                        </div> 
                        ...
                        <table >
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="border: 0.5px solid black"><input id="n2_sisa" name="n2_sisa" type="text"  size="2" value="{{ $data->n2_sisa }}"></td>
                                    <td style="border: 0.5px solid black"><input id="n2_ket" name="n2_ket" type="text"size="40" value="{{ $data->n2_ket }}"></td>
                                </tr>
                                <tr>
                                    <td style="border: 0.5px solid black">N-1</td>
                                    <td style="border: 0.5px solid black"><input id="n1_sisa" name="n1_sisa" type="text" size="2" value="{{ $data->n1_sisa }}"></td>
                                    <td style="border: 0.5px solid black"><input id="n1_ket" name="n1_ket" type="text" size="40" value="{{ $data->n1_ket }}"></td>
                                </tr>
                                <tr>
                                    <td style="border: 0.5px solid black">N</td>
                                    <td style="border: 0.5px solid black"><input id="n_sisa" name="n_sisa" type="text" size="2" value="{{ $data->n_sisa }}"></td>
                                    <td style="border: 0.5px solid black"><input id="n_ket" name="n_ket" type="text" size="40" value="{{ $data->n_ket }}"></td>
                                </tr>
                            </tbody>
                        </table>  
                        </div> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="namaatasan" type="text" value="{{ $data->namaatasan }}" class="form-control" readonly=""    required>
                                <input id="idatasan" type="hidden" value="{{ $data->idatasan }}" name="idatasan" required readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <option selected="selected">{{$data->pertimbangan}}</option>
                                <option value="-"></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="alasan_pertimbangan" value="{{ $data->alasan_pertimbangan }}" type="text" class="form-control" name="alasan_pertimbangan"   >
                            </div>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="namapejabat" type="text" value="{{ $data->namapejabat }}" class="form-control" readonly=""    required>
                                <input id="idpejabat" type="hidden" value="{{ $data->idpejabat }}" name="idpejabat" required readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group">                                    
                            ...
                            <option selected="selected">{{$data->keputusan}}</option>
                                <option value="-"></option>
                                <option value="Disetujui">Disetujui</option>
                                <option value="Perubahan">Perubahan</option>
                                <option value="Ditangguhkan">Ditangguhkan</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="alasan_keputusan" type="text" value="{{ $data->alasan_keputusan }}" class="form-control" name="alasan_keputusan"   >
                            </div>
                        </div> 
