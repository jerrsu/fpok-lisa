...
<form method="POST" action="{{ route('datapengabdian.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Pengabdian baru</h4>
                        ...
                        <div class="form-group ">
                            <label for="judul" class="col-md-4 control-label">Judul Pengabdian </label>
                            <div class="col-md-6">
