...
<form action="{{ route('datapengabdian.update', $data->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Edit Data Pengabdian</b> </h4>
                      ...
                      <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-6">
                                <input id="sumberdana" type="text" class="form-control" name="sumberdana" value="{{ $data->sumberdana }}"  >
                        ...
                        <div class="form-group ">
                            <label for="filepengabdian" class="col-md-4 control-label">File Pengabdian </label>
                            <div class="col-md-6">
                                <input id="filepengabdian" type="file" class="form-control" name="filepengabdian"   >
                        ...
                        <a href="{{route('datapengabdian.index')}}" class="btn btn-light pull-right">Back</a>
                    </div>
                  </div>
                </div>
              </div>
