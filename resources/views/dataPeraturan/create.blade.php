...
<form method="POST" action="{{ route('dataperaturan.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Data Peraturan baru</h4>                      
                         
                        <div class="form-group{{ $errors->has('no') ? ' has-error' : '' }}">
                            <label for="no" class="col-md-4 control-label">Nomor Peraturan <code>*</code></label>
                            <div class="col-md-6">
                                <input id="no" type="text" class="form-control" name="no" value="{{ old('no') }}" required=""  >
                                @if ($errors->has('judul'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="tentang" type="text" class="form-control" name="tentang"  >
