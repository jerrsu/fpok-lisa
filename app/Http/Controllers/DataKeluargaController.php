...
class DataKeluargaController extends Controller
{
    ...
    public function index()
    {
        ...
        if(Auth::user()->level == 3) {
            $datas = DataKeluargaViewer::where('idpegawai',Auth::user()->idpegawai)
                                ->get();
        }
        else{$datas = DataKeluargaViewer::all();}
        
        return view('dataKeluarga.index', compact('datas'));
    }
    ...
    public function create()
    {
        ...
        return view('dataKeluarga.create',compact('data'));
    }
    ...
    {   
        ...
        return view('dataKeluarga.edit', compact('data','datas','datas2'));
    }
